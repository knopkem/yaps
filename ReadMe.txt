...
PURPOSE
If you are like me and have a heap of photos and videos in randomly named folders laying on your hard disk you could run the tool over it and nicely sort them into a new folder structure. This could look like this:

year/month/timestamp.jpg 

Of course the structure can be customized to your need. Additionally all duplicate files can be removed which helps reducing waste of disk space.
...
ROADMAP
* add watch folder to easily drop photos from anywhere and auto import them into an existing archive 
